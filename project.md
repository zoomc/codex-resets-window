...
- An enabled switch is consumed before its CLI child process launches. This makes continuation single-use and prevents a stale passed reset timestamp from starting the same task again after a refresh or app restart.
